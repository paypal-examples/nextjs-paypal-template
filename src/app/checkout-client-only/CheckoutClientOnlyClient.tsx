...
// No eligibleMethodsResponse prop on purpose: this page tests a pure
// client-side eligibility fetch via useEligibleMethods(), with no server
// hydration.
const CheckoutClientOnlyClient = () => {
...
export default CheckoutClientOnlyClient;
