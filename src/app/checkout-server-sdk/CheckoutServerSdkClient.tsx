...
// hydration via react-paypal-js's own fetchEligibleMethods in isolation,
// with no client-side eligibility fetch.
...
export default CheckoutServerSdkClient;
